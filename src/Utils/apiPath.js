const pathObj = {
  ...
  soccerPlaceBet: "/v1/user/match/soccer-place-bet", addToFavourite: "/v1/user/match/add-to-favourite",
  favourtieList: "/v1/user/match/favourite-lists",
...
doLoginAndLaunchGisCasino: "/v1/wallet/doLoginAndLaunchGisCasino",
currentParlay:"/v1/user/match/my-parlay-bets",
  registerUser: "/v1/user/register",
checkSpin: "/v1/user/check-spin",
  updateSpin: "/v1/user/update-spin",
  referralReport: "/v1/user/referral-list",
  spinReport: "/v1/user/spin-report",
