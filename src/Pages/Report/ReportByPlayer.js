...
const ReportByPlayer = () => {
  return (
    <app-pl-player _nghost-serverapp-c118 className="ng-star-inserted">
      <div _ngcontent-serverapp-c118 className="main_wrap">
        <div _ngcontent-serverapp-c118 className="box">
          <h2 _ngcontent-serverapp-c118>Profit/Loss Report by Player</h2>
          {/**/}
        </div>
        <ul _ngcontent-serverapp-c118 className="report-tab-wrap">
          <li
            _ngcontent-serverapp-c118
            id="reportType_exchange"
            data-reporttabtype={0}
            className="report-tab select"
          >
            <a _ngcontent-serverapp-c118>Exchange</a>
          </li>
        </ul>
        <div _ngcontent-serverapp-c118 className="function-wrap">
          <ul _ngcontent-serverapp-c118 className="input-list flowroot">
            <div
              _ngcontent-serverapp-c118
              id="statusCondition"
              style={{ display: "none" }}
            >
              <li _ngcontent-serverapp-c118>
                <label _ngcontent-serverapp-c118>Bet Status:</label>
              </li>
              <li _ngcontent-serverapp-c118>
                <select
                  _ngcontent-serverapp-c118
            ...
            <li _ngcontent-serverapp-c118 />
            <li _ngcontent-serverapp-c118>
              <label _ngcontent-serverapp-c118>Period</label>
            </li>
            <li _ngcontent-serverapp-c118 className="contentclass">
              <input
                _ngcontent-serverapp-c118
                id="startDate"
                type="text"
          ...
          <ul _ngcontent-serverapp-c118 className="input-list flowroot">
            <li _ngcontent-serverapp-c118>
              <a _ngcontent-serverapp-c118 id="today" className="btn">
                Just for today
              </a>
            </li>
            <li _ngcontent-serverapp-c118>
              <a _ngcontent-serverapp-c118 id="yesterday" className="btn">
                From yesterday
              </a>
            </li>
            <li _ngcontent-serverapp-c118>
              <a _ngcontent-serverapp-c118 id="getPL" className="btn-send">
                Get P &amp; L
              </a>
            </li>
          </ul>
        </div>
        <div _ngcontent-serverapp-c118 id="noReportMessage" />
        <div _ngcontent-serverapp-c118 id="userTreeDiv" className="total_all">
          <input
            _ngcontent-serverapp-c118
            type="text"
          ...
          />
          <span _ngcontent-serverapp-c118 className="spacer" />
          <span _ngcontent-serverapp-c118>
            <label _ngcontent-serverapp-c118>Last:</label>
            <select
              _ngcontent-serverapp-c118
              name="limit"
              id="limit"
            ...
            >
              <option _ngcontent-serverapp-c118 value={100}>
                100 Txn
              </option>
              <option _ngcontent-serverapp-c118 value={50}>
                50 Txn
              </option>
              <option _ngcontent-serverapp-c118 value={25}>
                25 Txn
              </option>
              <option _ngcontent-serverapp-c118 value={10} selected>
                10 Txn
              </option>
              <option _ngcontent-serverapp-c118 value="downline.length">
                Full
              </option>
            </select>
            {/**/}
          ...
          <div _ngcontent-serverapp-c118 className="download-reports">
            <button
              _ngcontent-serverapp-c118
              title="Export Excel"
              className="excel btn"
        ...
        >
          ...
          >
            ...
            >
              <tbody _ngcontent-serverapp-c118>
                <tr _ngcontent-serverapp-c118 id="table_DL">
                  <th
                    _ngcontent-serverapp-c118
                    id="header_userName"
                    width="15%"
                  ...
                  >
                    <span
                      _ngcontent-serverapp-c118
                      className="Bdlevel lv_7 p premium"
                    />{" "}
                    Parent
                  </th>
                  <th
              ...
              <tbody _ngcontent-serverapp-c118 id="content">
                {/**/}
                {/**/}
                {/**/}
                <tr _ngcontent-serverapp-c118 className="total">
                  <td _ngcontent-serverapp-c118 className="align-L">
                    Total
                  </td>
                  <td _ngcontent-serverapp-c118 className="align-L" />
                  <td _ngcontent-serverapp-c118>
                    {/**/}
                    <div _ngcontent-serverapp-c118 className="ng-star-inserted">
                      <span
                        _ngcontent-serverapp-c118
                        className="ng-star-inserted"
                      >
                  ...
                  <td _ngcontent-serverapp-c118 id="_totalComm">
                    <span
                      _ngcontent-serverapp-c118
                      className="ng-star-inserted"
                    >
