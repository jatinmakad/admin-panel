...
const ReaportByAllCasino = () => {
  return (
    <app-global-report _nghost-serverapp-c117 className="ng-star-inserted">
      <div _ngcontent-serverapp-c117 className="main_wrap">
        <div _ngcontent-serverapp-c117 className="box">
          <h2 _ngcontent-serverapp-c117>Profit/Loss Report by All Casino</h2>
          <h2 _ngcontent-serverapp-c117 className="push" />
        </div>
        <ul _ngcontent-serverapp-c117 className="report-tab-wrap">
          <li
            _ngcontent-serverapp-c117
            id="reportType_exchange"
            data-reporttabtype={0}
            className="report-tab select"
          >
            <a _ngcontent-serverapp-c117>All</a>
          </li>
        </ul>
        <div _ngcontent-serverapp-c117 className="function-wrap">
          <ul _ngcontent-serverapp-c117 className="input-list flowroot">
            <div
              _ngcontent-serverapp-c117
              id="statusCondition"
              style={{ display: "none" }}
            >
              <li _ngcontent-serverapp-c117>
                <label _ngcontent-serverapp-c117>Bet Status:</label>
              </li>
              <li _ngcontent-serverapp-c117>
                <select
                  _ngcontent-serverapp-c117
            ...
            <li _ngcontent-serverapp-c117 />
            <li _ngcontent-serverapp-c117>
              <label _ngcontent-serverapp-c117>Period</label>
            </li>
            <li _ngcontent-serverapp-c117 className="contentclass">
              <input
                _ngcontent-serverapp-c117
                id="startDate"
                type="text"
            ...
            <li _ngcontent-serverapp-c117 style={{ display: "none" }}>
              (Time Zone:IST)
            </li>
            <li _ngcontent-serverapp-c117>
              <label _ngcontent-serverapp-c117>User List:</label>
              <ng-select
                _ngcontent-serverapp-c117
                name="sortCondition"
                id="sortCondition"
          ...
          <ul _ngcontent-serverapp-c117 className="input-list flowroot">
            <li _ngcontent-serverapp-c117>
              <a _ngcontent-serverapp-c117 id="today" className="btn">
                Just for today
              </a>
            </li>
            <li _ngcontent-serverapp-c117>
              <a _ngcontent-serverapp-c117 id="yesterday" className="btn">
                From yesterday
              </a>
            </li>
            <li _ngcontent-serverapp-c117 style={{ display: "none" }}>
              <a _ngcontent-serverapp-c117 id="last7days" className="btn">
                Last 7 days
              </a>
            </li>
            <li _ngcontent-serverapp-c117 style={{ display: "none" }}>
              <a _ngcontent-serverapp-c117 id="last30days" className="btn">
                Last 30 days
              </a>
            </li>
            <li _ngcontent-serverapp-c117 style={{ display: "none" }}>
              <a _ngcontent-serverapp-c117 id="last2months" className="btn">
                Last 2 Months
              </a>
            </li>
            <li _ngcontent-serverapp-c117 style={{ display: "none" }}>
              <a _ngcontent-serverapp-c117 id="last3months" className="btn">
                Last 3 Months
              </a>
            </li>
            <li _ngcontent-serverapp-c117>
              <a _ngcontent-serverapp-c117 id="getPL" className="btn-send">
                {" "}
                Get P &amp; L
              </a>
            </li>
        ...
        <div _ngcontent-serverapp-c117 id="noReportMessage" />
        <div _ngcontent-serverapp-c117 id="userTreeDiv" className="total_all">
          <ul _ngcontent-serverapp-c117 style={{ display: "none" }}>
            <li _ngcontent-serverapp-c117 id="tempTree">
              <a _ngcontent-serverapp-c117>
                <span _ngcontent-serverapp-c117 className="lv_1" />
              </a>
            </li>
            <li
              _ngcontent-serverapp-c117
            ...
            >
              <strong _ngcontent-serverapp-c117 />
            </li>
          </ul>
          <div _ngcontent-serverapp-c117 id="treePath" className="agent_path" />
          <div
            _ngcontent-serverapp-c117
            id="expandAllDiv"
            style={{ display: "none" }}
          >
            <a _ngcontent-serverapp-c117 id="showDetail" className="btn_expand">
              Expand All
            </a>
          </div>
          <span _ngcontent-serverapp-c117>
            <label _ngcontent-serverapp-c117>Last:</label>
            <select _ngcontent-serverapp-c117 name="limit" id="limit">
              <option _ngcontent-serverapp-c117 value={100}>
                100 Txn
              </option>
              <option _ngcontent-serverapp-c117 value={50}>
                50 Txn
              </option>
              <option _ngcontent-serverapp-c117 value={25} selected>
                25 Txn
              </option>
              <option _ngcontent-serverapp-c117 value={10}>
                10 Txn
              </option>
              <option _ngcontent-serverapp-c117 value="downline.length">
                Full
              </option>
            </select>
          </span>
          <span _ngcontent-serverapp-c117 className="spacer" />
          <span
            _ngcontent-serverapp-c117
          ...
          <div _ngcontent-serverapp-c117 className="download-reports">
            <button
              _ngcontent-serverapp-c117
              title="Export Excel"
              className="excel btn"
        ...
        >
          ...
          >
            ...
            >
              <tbody _ngcontent-serverapp-c117>
                <tr _ngcontent-serverapp-c117 id="table_DL">
                  <th
                    _ngcontent-serverapp-c117
                    id="header_userName"
                    width="15%"
              ...
              <tbody _ngcontent-serverapp-c117 id="content">
                {/**/}
                {/**/}
                {/**/}
                <tr _ngcontent-serverapp-c117 className="total">
                  <td _ngcontent-serverapp-c117 className="align-L">
                    Total
                  </td>
                  <td _ngcontent-serverapp-c117 id="_totalComm">
                    <span
                      _ngcontent-serverapp-c117
                  ...
                  <td _ngcontent-serverapp-c117>
                    {/**/}
                    <div _ngcontent-serverapp-c117 className="ng-star-inserted">
                      <span
                        _ngcontent-serverapp-c117
                        className="ng-star-inserted"
                      >
                  ...
                  <td _ngcontent-serverapp-c117 id="_totalDownlinePl">
                    <span
                      _ngcontent-serverapp-c117
                      className="ng-star-inserted"
                    >
                  ...
                  <td _ngcontent-serverapp-c117 id="_totalUplinePL">
                    <span
                      _ngcontent-serverapp-c117
                      className="ng-star-inserted"
                    >
...
export default ReaportByAllCasino;
