...
const BoCasinoBets = () => {
  return (
    <app-bogcasinoprovider _nghost-serverapp-c90 className="ng-star-inserted">
      <div
        _ngcontent-serverapp-c90
        className="full-wrap"
        style={{ height: "calc(100% - 105px)" }}
      >
        <div _ngcontent-serverapp-c90 className="over-wrap">
          <div _ngcontent-serverapp-c90 className="total_all">
            <span _ngcontent-serverapp-c90>
              <strong _ngcontent-serverapp-c90>BO Casino Bets</strong>
            </span>
            <div _ngcontent-serverapp-c90 className="spacer" />
            <span _ngcontent-serverapp-c90 className="total-users">
              {" "}
              Total Records: <strong _ngcontent-serverapp-c90>0</strong>
            </span>
            &nbsp;{" "}
            <span _ngcontent-serverapp-c90 className="total-users">
              {" "}
              Page Total PL:{" "}
              <strong _ngcontent-serverapp-c90 className="profit-text">
                0.00{" "}
              </strong>
            </span>
          </div>
          <div _ngcontent-serverapp-c90 className="function-wrap">
            <ul _ngcontent-serverapp-c90 className="input-list contentclass">
              <li _ngcontent-serverapp-c90>
                <label _ngcontent-serverapp-c90>Period:</label>
              </li>
              <li _ngcontent-serverapp-c90>
                <input
                  _ngcontent-serverapp-c90
                ...
                {/**/} to <br _ngcontent-serverapp-c90 />
                <input
                  _ngcontent-serverapp-c90
                  id="endDate"
                  type="text"
            ...
            <ul _ngcontent-serverapp-c90 className="input-list diaplayflex">
              <li _ngcontent-serverapp-c90>
                <input
                  _ngcontent-serverapp-c90
              ...
              <li _ngcontent-serverapp-c90>
                <label _ngcontent-serverapp-c90>Stake</label>
                <input
                  _ngcontent-serverapp-c90
                  type="number"
                  name="Volume Check"
                  className="textfield-input ng-untouched ng-pristine ng-valid"
                  placeholder="Stake"
                />
              </li>
              <li _ngcontent-serverapp-c90>
                <label _ngcontent-serverapp-c90>Last:</label>
                <select
                  _ngcontent-serverapp-c90
                  name="limit"
                  id="limit"
                  className="ng-untouched ng-pristine ng-valid"
                >
                  <option _ngcontent-serverapp-c90 value={10}>
                    10 Txn
                  </option>
                  <option _ngcontent-serverapp-c90 value={25}>
                    25 Txn
                  </option>
                  <option _ngcontent-serverapp-c90 value={50}>
                    50 Txn
                  </option>
                  <option _ngcontent-serverapp-c90 value={100}>
                    100 Txn
                  </option>
                  <option _ngcontent-serverapp-c90 value={0}>
                    Full - 0
                  </option>
                </select>
              </li>
              <li _ngcontent-serverapp-c90>
                <label _ngcontent-serverapp-c90>Sort by:</label>
                <select
                  _ngcontent-serverapp-c90
                  name="limit"
                  id="limit"
                  className="ng-untouched ng-pristine ng-valid"
                >
                  <option _ngcontent-serverapp-c90 value={1}>
                    Bet Settled Time
                  </option>
                  <option _ngcontent-serverapp-c90 value={0}>
                    Bet Taken Time
              ...
              <li _ngcontent-serverapp-c90 />
              <li _ngcontent-serverapp-c90>
                <a _ngcontent-serverapp-c90 id="getPL" className="btn-send">
                  Get History
                </a>
              </li>
              {/**/}
          ...
          <div _ngcontent-serverapp-c90 className="table-responsive data-table">
            <div _ngcontent-serverapp-c90 id="report">
              <table
                _ngcontent-serverapp-c90
                id="table_DL"
                className="table-s"
                style={{ display: "table" }}
              >
                <tbody _ngcontent-serverapp-c90>
                  <tr _ngcontent-serverapp-c90>
                    {/**/}
                    {/**/}
                    <th
                      _ngcontent-serverapp-c90
      ...
      <app-modal _ngcontent-serverapp-c90 _nghost-serverapp-c43>
        <div
        ...
        >
          ...
          >
            ...
            {/**/}
            <h3 _ngcontent-serverapp-c90 style={{ display: "flex" }}>
              Confirm Void Bet{" "}
              <a _ngcontent-serverapp-c90 className="close_pop">
                close_pop
              </a>
            </h3>
            <div _ngcontent-serverapp-c90 className="modal-content">
              <table _ngcontent-serverapp-c90 className="table-s">
                <tbody _ngcontent-serverapp-c90>
                  <tr _ngcontent-serverapp-c90>
                    <th _ngcontent-serverapp-c90>UID</th>
                    <th _ngcontent-serverapp-c90>Bet ID</th>
                    <th _ngcontent-serverapp-c90>Event</th>
                    <th _ngcontent-serverapp-c90>Bet Placed</th>
                    <th _ngcontent-serverapp-c90>PL</th>
                    <th _ngcontent-serverapp-c90>Stake</th>
                  </tr>
                  <tr _ngcontent-serverapp-c90>
                    <td _ngcontent-serverapp-c90 />
                    <td _ngcontent-serverapp-c90 />
                    <td _ngcontent-serverapp-c90>
                      {" "}
                      <img
            ...
            >
              <ul _ngcontent-serverapp-c90 className="btn-wrap">
                <li _ngcontent-serverapp-c90>
                  <label _ngcontent-serverapp-c90>Password:</label>
                  <input
                    _ngcontent-serverapp-c90
                    id="password"
                    type="password"
              ...
              <table _ngcontent-serverapp-c90 className="table-s">
                <tbody _ngcontent-serverapp-c90>
                  <tr _ngcontent-serverapp-c90>
                    ...
                    <th _ngcontent-serverapp-c90>PL</th>
                    <th _ngcontent-serverapp-c90>Stake</th>
                    <th _ngcontent-serverapp-c90>Action</th>
                  </tr>
                  {/**/}
                </tbody>
              </table>
