            ...
            >
              ...
              >
                ...
                <dd _ngcontent-serverapp-c111 id="myCreditLimit">
                  {" "}
                  USD
                  <span _ngcontent-serverapp-c111 className="ng-star-inserted">
                    {" "}
                    0.00
                  </span>
                </dd>
              ...
              >
                ...
                <dd _ngcontent-serverapp-c111 id="totalExposure">
                  {" "}
                  USD
                  <span style={{marginLeft:"5px"}} _ngcontent-serverapp-c111 className="red">
                    (0.00)
                  </span>
                </dd>
              </dl>
              ...
              <dl
                ...
                className="total_dl"
              >
                <dt _ngcontent-serverapp-c111>Transferable P/L with Upline</dt>
                <dd _ngcontent-serverapp-c111 id="totalCreditGivenOut">
                  {" "}
                  USD
                  <span style={{marginLeft:"5px"}} _ngcontent-serverapp-c111 className="ng-star-inserted">
                    <span
                      _ngcontent-serverapp-c111
            ...
            >
              ...
              <div _ngcontent-serverapp-c111 className="text-center">
                <span _ngcontent-serverapp-c111 id="user">
                  <i _ngcontent-serverapp-c111 className="fa fa-chevron-down" />
                </span>
              </div>
            </div>
                ...
                >
                  <tbody>
                    <tr>
                      ...
                      <th className=" sort_asc">Credit Refrence</th>{" "}
                      <th className="sort_asc">Balance</th>{" "}
                      <th className="sort_asc">Exposure</th>{" "}
                      <th className="sort_asc">Available Balance</th>
                      <th className=" sort_asc">Total Balance</th>{" "}
                      <th className=" sort_asc">Player Balance</th>{" "}
                      <th className=" sort_asc">Reference</th>{" "}
                      <th className=" sort_asc">Status</th>{" "}
                      <th className="align-R">Action</th>{" "}
                    </tr>
                    <tr style={{ fontWeight: "600" }}>
                      <td className="align-L">Total</td>{" "}
                      <td className="align-R">0.00</td>{" "}
                      <td className="align-R">0.00</td>{" "}
                      <td className="align-R">0.00</td>{" "}
                      <td className="align-R">0.00</td>{" "}
                    <td className="align-R">0.00</td>{" "}
                ...
                <div _ngcontent-serverapp-c43 className="pop_box pop_refer">
                  ...
                  >
                    <p _ngcontent-serverapp-c111 className="space-visitor">
                      ...
                      >
                        <i _ngcontent-serverapp-c111 className="fa fa-clone" />
                      </a>
                    </p>
                  </div>
                </div>
                ...
                <div _ngcontent-serverapp-c43 className="pop_box pop_refer">
                  ...
                  <div _ngcontent-serverapp-c111 className="wrap-refer_edit">
                    <div _ngcontent-serverapp-c111>
                      ...
                      <dl _ngcontent-serverapp-c111>
                        ...
                        >
                          <input
                            ...
                            className="ng-untouched ng-pristine ng-valid"
                          />
                          <a _ngcontent-serverapp-c111 className="btn tiptool">
                            <i
                              _ngcontent-serverapp-c111
                      ...
                      <dl _ngcontent-serverapp-c111>
                        <dt _ngcontent-serverapp-c111> Agent referral Comm </dt>
                        <dd
                          _ngcontent-serverapp-c111
                          style={{ "padding-left": "109px" }}
                        >
                        ...
                        <tbody _ngcontent-serverapp-c111>
                          <tr _ngcontent-serverapp-c111>
                            ...
                            <td
                              ...
                              className="align-r"
                            >
                              <label _ngcontent-serverapp-c111 className="xyz">
                                <input
                                  _ngcontent-serverapp-c111
                                  type="checkbox"
                                  className="ng-untouched ng-pristine ng-valid"
